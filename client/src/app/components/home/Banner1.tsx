			...
			>
				<article className='flex flex-col justify-start items-end order-1 px-8'>
					<div className='flex flex-col gap-y-4 max-w-lg z-20 mr-auto'>
						<h1 className='md:text-6xl text-4xl'>Sports Equipment Collection.</h1>
						...
						<button
							className='px-8 py-4 border border-black rounded-secondary bg-black hover:bg-black/90 text-white 
										  transition-colors drop-shadow w-fit mt-4'
						>
							Start Your Queries
						</button>
					</div>
